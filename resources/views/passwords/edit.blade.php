...
@section('content')
    <div class="flex justify-center">
        <div class="w-10/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{ route('edit', $password->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    border-red-500 @enderror"
                        value="{{ old('resource', $password->resource) }}">
                ...
                <div class="mb-4">
                    ...
                    border-red-500 @enderror"
                        value="{{ old('login', $password->login) }}">
                ...
                <div class="mb-4">
                    ...
                    border-red-500 @enderror"
                        value="{{ old('password_to_resource', $password->password) }}">
                ...
                <div class="mb-4">
                    ...
                    border-red-500 @enderror"
                        value="">{{ old('additional_info', $password->additional_info) }}</textarea>
