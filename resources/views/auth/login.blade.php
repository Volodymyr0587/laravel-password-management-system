...
@section('content')
    <div class="flex justify-center">
        <div class="w-2/5 bg-white p-6 rounded-lg">
            @if (session('status'))
                <div class="bg-red-500 p-4 mb-4 rounded-lg text-white text-center">
                    {{ session('status') }}
                </div>
            @endif
            ...
            <p class="mt-4">Don't have an account yet? <a href="{{ route('register') }}" class="text-blue-500">Sign up!</a></p>
